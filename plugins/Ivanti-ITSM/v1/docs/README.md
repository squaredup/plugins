...
| **Page limit** | The most records Ivanti returns in one request. Paged streams fetch in pages of this size, and **Business Object Records** returns at most this many, so no request exceeds it. | Set by an Ivanti administrator for the tenant — ask them for the value. It is 100 unless they have raised it. | No (defaults to 100) |
