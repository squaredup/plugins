...
- **Player Activity** — daily game and puzzle win/loss/draw counts for a player.
...
- **Activity history is a fixed rolling window** — the Player Activity stream reflects roughly the last 20 days with recorded activity and has no timeframe picker.
