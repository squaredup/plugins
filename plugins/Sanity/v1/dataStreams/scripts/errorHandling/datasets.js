...
result = hasToken
    ...
    : 'No API token is configured for project ' + {{ JSON.stringify(object.name) }} + '. Add its Project ID and API token under Project API tokens in the Sanity data source settings to see its datasets.';
