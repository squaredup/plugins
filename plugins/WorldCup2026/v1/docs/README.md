...
This plugin connects to the community API at [worldcup26.ir](https://worldcup26.ir) — an unofficial, community-maintained data source. It is not an official FIFA API. Data coverage and availability depends on the third party keeping the service running.
